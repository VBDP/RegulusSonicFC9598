Shader "Hidden/Locked/.poiyomi/Old Versions/9.0/Poiyomi Toon/9231746cc93671a4b8e388f072b5517c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (0.385 /*_AlphaMod*/));
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				poiLight.finalLighting = max(POI_BRDF_PBS(1, 0, 0, 0, poiMesh.normals[1], poiCam.viewDir, light, indirectLight).xyz, (0.2 /*_LightingMinLightBrightness*/));
				#endif
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal2.m_DecalHueShift = (0.05 /*_DecalHueShift2*/);
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#if defined(PROP_MATCAP2) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (1.0 /*_Matcap2UVMode*/), (1.0 /*_Matcap2UVToBlend*/), float4(0,0,0,0).xy, (0.039 /*_Matcap2Rotation*/), (0.53 /*_Matcap2Border*/), normal1, poiCam, poiLight, poiMesh, (1.0 /*_Matcap2Normal*/), matcapALD);
				...
				#endif
				matcapIntensity = (0.41 /*_Matcap2Intensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap2Add*/), (0.345 /*_Matcap2AddToLight*/), (0.668 /*_Matcap2Multiply*/), (0.0 /*_Matcap2Replace*/), (0.0 /*_Matcap2Mixed*/), (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.6 /*_Matcap2EmissionStrength*/), (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef POI_MATCAP2
				...
				#if defined(PROP_MATCAP3) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (1.0 /*_Matcap3UVMode*/), (1.0 /*_Matcap3UVToBlend*/), float4(0,0,0,0).xy, (0.119 /*_Matcap3Rotation*/), (0.32 /*_Matcap3Border*/), normal2, poiCam, poiLight, poiMesh, (1.0 /*_Matcap3Normal*/), matcapALD);
				...
				#endif
				matcapIntensity = (0.61 /*_Matcap3Intensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
					matcapIntensity += lerp(matcapALD.matcapALIntensityAdd.x, matcapALD.matcapALIntensityAdd.y, poiMods.audioLink[matcapALD.matcapALIntensityAddBand]);
				...
				matcap3.rgb = lerp(matcap3.rgb, matcap3.rgb * poiFragData.baseColor.rgb, (0.033 /*_Matcap3BaseColorMix*/));
				#if defined(PROP_MATCAP3MASK) || !defined(OPTIMIZER_ENABLED)
				...
				{
					matcap3.rgb = hueShift(matcap3.rgb, (0.311 /*_Matcap3HueShift*/) + _Time.x * (0.0 /*_Matcap3HueShiftSpeed*/), (0.0 /*_Matcap3HueShiftColorSpace*/));
				}
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.203 /*_Matcap3Add*/), (0.0 /*_Matcap3AddToLight*/), (0.397 /*_Matcap3Multiply*/), (0.0 /*_Matcap3Replace*/), (0.0 /*_Matcap3Mixed*/), (0.116 /*_Matcap3Screen*/), matcap3, matcap3Mask, (0.3 /*_Matcap3EmissionStrength*/), (0.0 /*_Matcap3LightMask*/), (0.0 /*_Matcap3MaskGlobalMask*/), (2.0 /*_Matcap3MaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef POI_MATCAP3
				...
				#if defined(PROP_MATCAP4) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (1.0 /*_Matcap4UVMode*/), (1.0 /*_Matcap4UVToBlend*/), float4(0,0,0,0).xy, (0.079 /*_Matcap4Rotation*/), (0.58 /*_Matcap4Border*/), normal3, poiCam, poiLight, poiMesh, (1.0 /*_Matcap4Normal*/), matcapALD);
				if ((0.0 /*_Matcap4SmoothnessEnabled*/))
				{
					...
					matcap4 = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap4, _trilinear_repeat, TRANSFORM_TEX(matcapUV, _Matcap4), matcap4Smoothness) * float4(poiThemeColor(poiMods, float4(1,0.8933861,0.866134,1).rgb, (0.0 /*_Matcap4ColorThemeIndex*/)), float4(1,0.8933861,0.866134,1).a);
				}
				else
				{
					matcap4 = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap4, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap4)) * float4(poiThemeColor(poiMods, float4(1,0.8933861,0.866134,1).rgb, (0.0 /*_Matcap4ColorThemeIndex*/)), float4(1,0.8933861,0.866134,1).a);
				}
				#else
				matcap4 = float4(poiThemeColor(poiMods, float4(1,0.8933861,0.866134,1).rgb, (0.0 /*_Matcap4ColorThemeIndex*/)), float4(1,0.8933861,0.866134,1).a);
				#endif
				matcapIntensity = (0.24 /*_Matcap4Intensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
					matcapIntensity += lerp(matcapALD.matcapALIntensityAdd.x, matcapALD.matcapALIntensityAdd.y, poiMods.audioLink[matcapALD.matcapALIntensityAddBand]);
				...
				{
					matcap4.rgb = hueShift(matcap4.rgb, (0.823 /*_Matcap4HueShift*/) + _Time.x * (0.0 /*_Matcap4HueShiftSpeed*/), (0.0 /*_Matcap4HueShiftColorSpace*/));
				}
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap4Add*/), (0.0 /*_Matcap4AddToLight*/), (0.479 /*_Matcap4Multiply*/), (0.0 /*_Matcap4Replace*/), (0.0 /*_Matcap4Mixed*/), (0.0 /*_Matcap4Screen*/), matcap4, matcap4Mask, (1.0 /*_Matcap4EmissionStrength*/), (0.0 /*_Matcap4LightMask*/), (0.0 /*_Matcap4MaskGlobalMask*/), (2.0 /*_Matcap4MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				if ((0.0 /*_ScrollingEmission*/))
				{
					...
					{
						#if defined(PROP_EMISSIONSCROLLINGCURVE) || !defined(OPTIMIZER_ENABLED)
						emissionStrength0 *= UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionScrollingCurve, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)) + (dot(pos, float4(15,0,0,0).xyz) * (20.0 /*_EmissiveScroll_Interval*/)) + _Time.x * (10.0 /*_EmissiveScroll_Velocity*/)).r;
						#endif
					}
					else
					{
						emissionStrength0 *= calculateScrollingEmission(float4(15,0,0,0).xyz, (10.0 /*_EmissiveScroll_Velocity*/), (20.0 /*_EmissiveScroll_Interval*/), (2.0 /*_EmissiveScroll_Width*/), (0.0 /*_EmissionScrollingOffset*/), pos);
					}
				}
			...
			float3 applyEmission2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionStrength2 = (0.3 /*_EmissionStrength2*/);
			...
			float3 RandomColorFromPoint(float2 rando, PoiMods poiMods)
			{
				...
				fixed saturation = lerp(float4(0.1593404,0.6574691,0,1).x, float4(0.1593404,0.6574691,0,1).y, rando.x);
				fixed value = lerp(float4(0.3052331,1,0,1).x, float4(0.3052331,1,0,1).y, rando.y);
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					float2 st = (poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,0,0,0).xy * _Time.x) * (200.0 /*_GlitterFrequency*/);
					...
					float size = (0.545 /*_GlitterSize*/);
					
					if ((1.0 /*_GlitterRandomSize*/))
					{
						size = lerp(float4(0.2332065,0.4111957,0,1).x, float4(0.2332065,0.4111957,0,1).y, randomFromPoint);
					}
					#ifdef POI_AUDIOLINK
					if ((0.0 /*_GlitterALEnabled*/))
					{
					...
					switch((1.0 /*_GlitterShape*/))
					{
						...
						if ((1.0 /*_GlitterRandomRotation*/) == 1 || (1.5 /*_GlitterTextureRotation*/) != 0 || float4(0,0,0,0).x != 0 || float4(0,0,0,0).y != 0 || glitterRotationTimeOffset != 0)
						{
							...
							if (glitterRandomRotationSpeed.x + glitterRandomRotationSpeed.y + (1.5 /*_GlitterTextureRotation*/) == 0 && glitterRotationTimeOffset != 0)
							{
								glitterRandomRotationSpeed = 1;
							}
							float theta = radians((randomBoy + (_Time.x + glitterRotationTimeOffset) * ((1.5 /*_GlitterTextureRotation*/) + glitterRandomRotationSpeed)) * 360);
							float cs = cos(theta);
							float sn = sin(theta);
					...
					switch((0.0 /*_GlitterMode*/))
					{
						...
						{
							randomRotation = randomFloat3WiggleRange(randoPoint, (90.0 /*_GlitterAngleRange*/), (5.0 /*_GlitterSpeed*/), glitterSpeedOffset);
						}
						else
						{
					...
					glitterColor *= lerp(1, poiFragData.baseColor, (0.634 /*_GlitterUseSurfaceColor*/));
					#if defined(PROP_GLITTERCOLORMAP) || !defined(OPTIMIZER_ENABLED)
					...
					if ((1.0 /*_GlitterRandomRotation*/) == 1 || (1.5 /*_GlitterTextureRotation*/) != 0 || float4(0,0,0,0).x != 0 || float4(0,0,0,0).y && !(1.0 /*_GlitterShape*/) || glitterRotationTimeOffset != 0)
					{
					...
					{
						poiFragData.baseColor = lerp(poiFragData.baseColor, finalGlitter * glitterColor * ((7.5 /*_GlitterBrightness*/) + GlitterbrightnessOffset), finalGlitter * glitterTexture.a * glitterMask);
						poiFragData.emission += finalGlitter * glitterColor * max(0, (((7.5 /*_GlitterBrightness*/) + GlitterbrightnessOffset) - 1) * glitterTexture.a) * glitterMask;
					}
					else
					{
						poiFragData.emission += finalGlitter * glitterColor * ((7.5 /*_GlitterBrightness*/) + GlitterbrightnessOffset) * glitterTexture.a * glitterMask;
					}
				}
			}
			#endif
			...
			{
				float smoothness = (0.621 /*_MochieRoughnessMultiplier*/);
				...
				#endif
				reflectionMask *= (0.68 /*_MochieReflectionStrength*/);
				specularMask *= (2.11 /*_MochieSpecularStrength*/);
			...
			{
				float3 parallax = 0;
				for (int j = (7.0 /*_ParallaxInternalIterations*/) - 1; j >= 0; j--)
				{
					float ratio = saturate((float)j / max((7.0 /*_ParallaxInternalIterations*/) - 1, 1));
					float2 parallaxOffset = _Time.y * (float4(0,0,0,0) + ratio * float4(0.15,0,0,0));
					float fade = lerp((0.0 /*_ParallaxInternalMinFade*/), (0.73 /*_ParallaxInternalMaxFade*/), ratio);
					fade = pow(fade, 2.2);
					#if defined(PROP_PARALLAXINTERNALMAP) || !defined(OPTIMIZER_ENABLED)
					float4 parallaxColor = UNITY_SAMPLE_TEX2D_SAMPLER(_ParallaxInternalMap, _MainTex, TRANSFORM_TEX(poiMesh.uv[0], _ParallaxInternalMap) + (lerp((0.28 /*_ParallaxInternalMinDepth*/), (0.05 /*_ParallaxInternalMaxDepth*/), ratio)) * - (poiCam.tangentViewDir.xy / (poiCam.tangentViewDir.z)) + parallaxOffset);
					#else
					float4 parallaxColor = 0;
					#endif
					float3 minColor = poiThemeColor(poiMods, float4(0.08077289,0,1,1).rgb, (0.0 /*_ParallaxInternalMinColorThemeIndex*/));
					float3 maxColor = poiThemeColor(poiMods, float4(0.5463194,0,1,1).rgb, (0.0 /*_ParallaxInternalMaxColorThemeIndex*/));
				...
				#if defined(PROP_PARALLAXINTERNALMAPMASK) || !defined(OPTIMIZER_ENABLED)
				poiFragData.baseColor.rgb = customBlend(poiFragData.baseColor.rgb, parallax.rgb, (5.0 /*_ParallaxInternalSurfaceBlendMode*/), POI2D_SAMPLER_PAN(_ParallaxInternalMapMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_ParallaxInternalMapMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0))[(0.0 /*_ParallaxInternalMapMaskChannel*/)]);
				#else
				poiFragData.baseColor.rgb = customBlend(poiFragData.baseColor.rgb, parallax.rgb, (5.0 /*_ParallaxInternalSurfaceBlendMode*/));
				#endif
			}
			#endif
			#ifdef POI_BACKLIGHT
			...
			{
				float3 backlightColor = float4(0.2278193,0,1,1).rgb;
				#if defined(PROP_BACKLIGHTCOLORTEX) || !defined(OPTIMIZER_ENABLED)
				...
				float backlightLN = dot(normalize(-headDir * (0.445 /*_BacklightViewStrength*/) + poiLight.direction), normal) * 0.5 + 0.5;
				#if defined(POINT) || defined(SPOT)
				...
				#endif
				backlightLN = poiEdgeLinear(backlightLN, (0.683 /*_BacklightBorder*/), (0.742 /*_BacklightBlur*/));
				float backlight = saturate(backlightFactor * backlightLN);
				backlight = !poiMesh.isFrontFace && (1 /*_BacklightBackfaceMask*/) ? 0.0 : backlight;
				backlightColor = lerp(backlightColor, backlightColor * poiFragData.baseColor, (0.694 /*_BacklightMainStrength*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRimLight*/), (0.0 /*_RimLightingInvert*/), (1.64 /*_RimPower*/), (0.0 /*_RimStrength*/), (0.0 /*_RimShadowWidth*/), (0.0 /*_RimShadowToggle*/), (0.945 /*_RimWidth*/), (1.0 /*_RimBlendStrength*/), rimMask, (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), rimColor, float4(1,1,1,1), (0.0 /*_RimLightColorThemeIndex*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftColorSpace*/), (0.0 /*_RimHueShiftSpeed*/),  (0.107 /*_RimSharpness*/), (0.0 /*_RimShadowMaskRampType*/), (0.0 /*_RimShadowMaskInvert*/), (1.0 /*_RimShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_RimApplyGlobalMaskIndex*/), (2.0 /*_RimApplyGlobalMaskBlendType*/), (1.0 /*_RimBaseColorMix*/), (2.56 /*_RimBrightness*/), (0.0 /*_RimPoiBlendMode*/), AudioLinkRimWidthBand, AudioLinkRimWidthAdd, AudioLinkRimEmissionBand, AudioLinkRimEmissionAdd, AudioLinkRimBrightnessBand, AudioLinkRimBrightnessAdd, rimBias, (0.0 /*_RimBiasIntensity*/), (0 /*_RimApplyAlpha*/), (1.0 /*_RimApplyAlphaBlend*/));
				#endif
				#endif
				#ifdef _SUNDISK_SIMPLE
