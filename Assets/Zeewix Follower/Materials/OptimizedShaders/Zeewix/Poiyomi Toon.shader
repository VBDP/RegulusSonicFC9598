Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/6fafe6edcc5cdc44eb1b5692b928272e"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				poiLight.finalLighting = max(POI_BRDF_PBS(1, 0, 0, 0, poiMesh.normals[1], poiCam.viewDir, light, indirectLight).xyz, (0.1 /*_LightingMinLightBrightness*/));
				#endif
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#if defined(PROP_MATCAP2) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (1.0 /*_Matcap2UVMode*/), (1.0 /*_Matcap2UVToBlend*/), float4(0,0,0,0).xy, (0.119 /*_Matcap2Rotation*/), (0.32 /*_Matcap2Border*/), normal1, poiCam, poiLight, poiMesh, (1.0 /*_Matcap2Normal*/), matcapALD);
				...
				#endif
				matcapIntensity = (0.61 /*_Matcap2Intensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
				...
				matcap2.rgb = lerp(matcap2.rgb, matcap2.rgb * poiFragData.baseColor.rgb, (0.073 /*_Matcap2BaseColorMix*/));
				#if defined(PROP_MATCAP2MASK) || !defined(OPTIMIZER_ENABLED)
				...
				{
					matcap2.rgb = hueShift(matcap2.rgb, (0.0 /*_Matcap2HueShift*/) + _Time.x * (0.311 /*_Matcap2HueShiftSpeed*/), (0.0 /*_Matcap2HueShiftColorSpace*/), (0.0 /*_Matcap2HueSelectOrShift*/));
				}
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.753 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (0.257 /*_Matcap2Multiply*/), (0.0 /*_Matcap2Replace*/), (0.0 /*_Matcap2Mixed*/), (0.08 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.3 /*_Matcap2EmissionStrength*/), (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef POI_MATCAP2
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.73 /*_Matcap3Add*/), (0.0 /*_Matcap3AddToLight*/), (0.5 /*_Matcap3Multiply*/), (0.0 /*_Matcap3Replace*/), (0.0 /*_Matcap3Mixed*/), (0.0 /*_Matcap3Screen*/), matcap3, matcap3Mask, (0.0 /*_Matcap3EmissionStrength*/), (0.0 /*_Matcap3LightMask*/), (0.0 /*_Matcap3MaskGlobalMask*/), (2.0 /*_Matcap3MaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef POI_MATCAP3
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.61 /*_Matcap4Add*/), (0.0 /*_Matcap4AddToLight*/), (0.28 /*_Matcap4Multiply*/), (0.0 /*_Matcap4Replace*/), (0.0 /*_Matcap4Mixed*/), (0.0 /*_Matcap4Screen*/), matcap4, matcap4Mask, (0.0 /*_Matcap4EmissionStrength*/), (0.0 /*_Matcap4LightMask*/), (0.0 /*_Matcap4MaskGlobalMask*/), (2.0 /*_Matcap4MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionStrength1 = (0.3 /*_EmissionStrength1*/);
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				for (uint glitterLayer = 0; glitterLayer < uint((2.0 /*_GlitterLayers*/)); glitterLayer++)
				{
					...
					{
						size = lerp(float4(0.3998217,0.5778109,0,1).x, float4(0.3998217,0.5778109,0,1).y, randomFromPoint);
					}
					#ifdef POI_AUDIOLINK
					if ((0.0 /*_GlitterALEnabled*/))
					{
					...
					{
						glitterColor.rgb = hueShift(glitterColor.rgb, (0.0 /*_GlitterHueShift*/) + _Time.x * (0.0 /*_GlitterHueShiftSpeed*/), (0.0 /*_GlitterHueShiftColorSpace*/), (0.0 /*_GlitterHueSelectOrShift*/));
					}
			...
			{
				float smoothness = (0.447 /*_MochieRoughnessMultiplier*/);
				...
				specularMask *= (0.56 /*_MochieSpecularStrength*/);
			...
			void applyInternalParallax(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				for (int j = (7.0 /*_ParallaxInternalIterations*/) - 1; j >= 0; j--)
				{
					...
					float2 parallaxOffset = _Time.y * (float4(0,0,0,0) + ratio * float4(0,0,0,0));
					...
					#endif
					float3 minColor = poiThemeColor(poiMods, float4(0.08077287,0,1,1).rgb, (0.0 /*_ParallaxInternalMinColorThemeIndex*/));
					...
					parallaxTint = hueShift(parallaxTint, frac(ratio * (0.0 /*_ParallaxInternalHueShiftPerLevel*/)) * (0.0 /*_ParallaxInternalHueShiftEnabled*/), (0.0 /*_ParallaxInternalHueShiftColorSpace*/), (0.0 /*_ParallaxInternalHueSelectOrShift*/));
				...
				parallax = hueShift(parallax, frac((0.0 /*_ParallaxInternalHueShift*/) + (0.0 /*_ParallaxInternalHueShiftSpeed*/) * _Time.x) * (0.0 /*_ParallaxInternalHueShiftEnabled*/), (0.0 /*_ParallaxInternalHueShiftColorSpace*/), (0.0 /*_ParallaxInternalHueSelectOrShift*/));
				#if defined(PROP_PARALLAXINTERNALMAPMASK) || !defined(OPTIMIZER_ENABLED)
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRimLight*/), (0.0 /*_RimLightingInvert*/), (0.6 /*_RimPower*/), (0.0 /*_RimStrength*/), (0.0 /*_RimShadowWidth*/), (0.0 /*_RimShadowToggle*/), (1.0 /*_RimWidth*/), (1.0 /*_RimBlendStrength*/), rimMask, (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), rimColor, float4(1,1,1,1), (0.0 /*_RimLightColorThemeIndex*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftColorSpace*/), (1.0 /*_RimHueSelectOrShift*/), (0.0 /*_RimHueShiftSpeed*/),  (0.13 /*_RimSharpness*/), (0.0 /*_RimShadowMaskRampType*/), (0.0 /*_RimShadowMaskInvert*/), (1.0 /*_RimShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_RimApplyGlobalMaskIndex*/), (2.0 /*_RimApplyGlobalMaskBlendType*/), (1.0 /*_RimBaseColorMix*/), (1.45 /*_RimBrightness*/), (0.0 /*_RimPoiBlendMode*/), AudioLinkRimWidthBand, AudioLinkRimWidthAdd, AudioLinkRimEmissionBand, AudioLinkRimEmissionAdd, AudioLinkRimBrightnessBand, AudioLinkRimBrightnessAdd, rimBias, (0.0 /*_RimBiasIntensity*/), (0 /*_RimApplyAlpha*/), (1.0 /*_RimApplyAlphaBlend*/));
				#endif
				#endif
				#ifdef _SUNDISK_SIMPLE
