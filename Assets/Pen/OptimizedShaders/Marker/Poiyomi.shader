Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/89f268a0ce2c8334bb7f8bf4ad61261f"
{
	Properties
	{
 ...
 #define POI_VERTEXLIGHT_ON 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,0.4677838,0,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,0.4677838,0,1).a;
				//ifex float(1)==0
