Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/9566af2789057744f9260e27e3217521"
{
	Properties
	{
		...
		_DepthColorMinValue ("Min Color Blend", Range(0, 1)) = 0
		_DepthColorMaxValue ("Max Color Blend", Range(0, 1)) = 1
