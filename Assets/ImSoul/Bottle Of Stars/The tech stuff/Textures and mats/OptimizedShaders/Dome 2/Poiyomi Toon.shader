Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/da3a4961dba49b741b0f5c254c5223ed"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				+ (0.0 /*_DissolveAlpha8*/)
				+ (0.0 /*_DissolveAlpha9*/);
				float dds = (0.06 /*_DissolveDetailStrength*/);
				...
				#if defined(PROP_DISSOLVEDETAILNOISE) || !defined(OPTIMIZER_ENABLED)
				float dissolveDetailNoise = POI2D_SAMPLER_PAN(_DissolveDetailNoise, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DissolveDetailNoiseUV*/)], float4(1,1,0,0)), float4(0.5,0,0,0));
				#else
				...
				switch((4.0 /*_DissolveType*/))
				{
					default: // Basic (case 1)
					{
						...
						edgeAlpha = remapClamped(da + (0.015 /*_DissolveEdgeWidth*/), da, noise) * (1 - dissolveAlpha);
						break;
					}
					case 2: // Point to Point
					{
						...
						float3 currentPos;
						float distanceTo = 0;
						direction = normalize(float4(0,-1.1,0,0) - float4(0,0,0,0));
						currentPos = lerp(float4(0,0,0,0), float4(0,-1.1,0,0), dissolveAlpha);
					...
					case 3: // Spherical
					{
						...
						{
							da = remap(da, 1, 0, -(0.015 /*_DissolveEdgeWidth*/), 1);
						}
						else
						{
							da = remap(da, 0, 1, -(0.015 /*_DissolveEdgeWidth*/), 1);
						...
						if ((0.0 /*_SphericalDissolveInvert*/))
						{
							...
							edgeAlpha = smoothstep((0.015 /*_DissolveEdgeWidth*/) + .00001, 0, -normalizedDistance);
						}
						else
						{
							dissolveAlpha = (normalizedDistance < 0) ? 1 : 0;
					...
					case 4: // CenterOut
					{
						...
						switch((2.0 /*_CenterOutDissolveMode*/))
						{
							...
							{
								ramp = dot(normalize(float4(0,1,0,0)), lerp(poiMesh.normals[0], poiMesh.normals[1], (0.0 /*_CenterOutDissolveNormals*/)));
				...
				if ((0.015 /*_DissolveEdgeWidth*/) || ((4.0 /*_DissolveType*/) == 2 && (0.1 /*_DissolveP2PEdgeLength*/) != 0))
				{
				...
				poiFragData.emission += lerp(0, dissolveToTexture * (0.0 /*_DissolveToEmissionStrength*/), dissolveAlpha) + lerp(0, edgeColor.rgb * (8.69 /*_DissolveEdgeEmission*/), smoothstep(0, 1 - (0.0 /*_DissolveEdgeHardness*/) * .99999999999, edgeAlpha));
				#endif
			}
			#endif
