Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/4df3a58329132794ca3c5a2356c417f2"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(236.0202,236.0202,236.0202,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(236.0202,236.0202,236.0202,1).a;
				...
				poiFragData.baseColor = saturate(lerp(poiFragData.baseColor, poiFragData.baseColor * ((0.5 /*_MainBrightness*/) + 1), hueShiftAlpha.g));
				#endif
				#if defined(PROP_ALPHAMASK) || !defined(OPTIMIZER_ENABLED)
